...
class ActionReducerMapBuilder(Generic[T]):
    def __init__(self):
        self.actions_map: dict[ActionableStateItem, Callable[[PyducksState, Optional[ActionableStateItem]], Any]] = {}
        self.matchers_map: dict[Callable[[ActionableStateItem], bool], Callable[[PyducksState, Optional[ActionableStateItem]], Any]] = {}
        self.default_reducer: Callable[[PyducksState, Optional[ActionableStateItem]], Any] = None
