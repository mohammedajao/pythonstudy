...
@dataclass
@s(auto_attribs=True)
class BattleState(PyducksState):
    player: Character
    enemy: Character
...
#     "player": PyducksReducer(character_reducer),
#     "enemy": PyducksReducer(character_reducer),
#     "battle_log": PyducksReducer(battle_reducer)
# })

store = PyducksStore(battle_reducer, initial_state)
